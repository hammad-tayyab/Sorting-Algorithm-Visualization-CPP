...
void selectionSort(Visualizer& viz, vector<int>& arr);
void mergeSort(Visualizer& viz, vector<int>& arr);
void insertionSort(Visualizer& viz, vector<int>& arr);
void quickSort(Visualizer& viz, vector<int>& arr);
void heapSort(Visualizer& viz, vector<int>& arr);
...
int main()
{
    ...
    while (true)
    {
        ...
        // shuffled numbers 1 to 50
        vector<int> arr = {45, 50, 31, 10, 49, 15, 27, 4, 38, 12, 
                           2, 1, 33, 8, 42, 19, 26, 7, 44, 21, 
        ...
        // opening the visualization screen
